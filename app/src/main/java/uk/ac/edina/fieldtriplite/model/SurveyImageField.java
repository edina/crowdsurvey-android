 ...
 */
public class SurveyImageField extends SurveyFieldBase {
    protected SurveyImageField(String id, String label, Type type, Boolean required, Boolean persistent, SurveyFieldProperties surveyFieldProperties, int formId) {
